package exam.hughwu.cathaytest.feature.stocklist.hybrid
...
class StockListFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        parentFragmentManager.setFragmentResultListener(
            ...
            val orderName = bundle.getString(StockSortBottomSheet.Companion.RESULT_SORT_ORDER) ?: return@setFragmentResultListener
