 ...
 * via [XmlStockAdapter], no Compose at all).
 *
 * Behaviour is identical to [StockListFragment]; the only differences are the
 * adapter (pure XML), the layout, and that the [StockListViewModel] is
...
class StockListXmlFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        parentFragmentManager.setFragmentResultListener(
            ...
            val orderName = bundle.getString(StockSortBottomSheet.RESULT_SORT_ORDER)
